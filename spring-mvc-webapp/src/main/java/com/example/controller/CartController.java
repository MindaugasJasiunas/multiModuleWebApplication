...
public class CartController {
    ...
    @RequestMapping("/cart")
    public String showShoppingCartPage(@AuthenticationPrincipal UserDetails user, Model model){
    ...
    @GetMapping("/checkout")
    public String showCheckoutPage(@AuthenticationPrincipal UserDetails user, Model model){
        if(userEntityService.isUserExistsByUserEntityEmail(user.getUsername())) {
            if (userEntityService.isUserExistsByUserEntityEmail(user.getUsername())) {
                UserEntity userEntity = userEntityService.findUserEntityByEmail(user.getUsername()).get();
